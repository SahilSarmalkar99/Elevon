  ...
  return (
    <section className="w-full bg-black text-white px-6 md:px-10 lg:px-16 py-20 md:py-28">
      ...
      <div className="max-w-7xl mx-auto">
        ...
        {/* HEADING */}
        <h2 className="mt-8 text-4xl sm:text-5xl md:text-6xl font-[font5] leading-tighter tracking-tighter">
          Awards & <br /> Achievements
        </h2>

        {/* SUBTEXT */}
        <p className="mt-6 font-[font5] text-gray-400 max-w-md text-base md:text-lg">
      ...
      {/* LIST */}
      <div className="max-w-7xl mx-auto mt-16 font-[font5] space-y-2">
